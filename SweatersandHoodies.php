...
<head>
    ...
    <title>Sweaters and Hoodies</title>
</head>
    ...
    <div class="container-fluid">
        <div class="col-md-12">
            <div class="row">
                ...
                <?php
                echo "<h1 class='text-center'>Sweaters and Hoodies</h1>";
                include "../admin/product/dbConfig.php";
                $result_set = $conn->query("SELECT * FROM `prod_table` Where PCategory = 'Sweaters and Hoodies' ");
